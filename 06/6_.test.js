const { customsP1 } = require("./6_p1");
const { customsP2 } = require("./6_p2");
...
describe("Day 6 - Part 1", () => {
  ...
  it("should return the sum of answers from the real data", () => {
    expect(customsP1(data)).toBe(6633);
  });
});

describe("Day 6 - Part 2", () => {
  it("should return the sum of answers from the test data ", () => {
    expect(customsP2(testData)).toBe(6);
  });
  it("should return the sum of answers from the real data ", () => {
    expect(customsP2(data)).toBe(3202);
  });
});
