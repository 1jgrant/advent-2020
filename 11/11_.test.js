...
const data = `LLLLL.LLLLLLL.LLLLLL.L.LLLL..LLLL.LLLLLLLLL.LLLLLLLL.LLLLLLLLLLLLL.L.LLLLLLLLLLLLLL.LLLLLL
...
describe("Day 11 P1", () => {
  test("should return the number of occupied seats with the test data", () => {
    expect(seating(testData)).toBe(37);
  });
  test("should return the number of occupied seats with the puzzle data", () => {
    expect(seating(data)).toBe(2299);
  });
});
