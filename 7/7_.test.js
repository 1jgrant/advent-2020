const { bagRules, expand } = require("./7_p1");
...
const data = `dark olive bags contain 2 muted brown bags, 1 mirrored tomato bag, 4 bright black bags.
...
describe("Day 7 - p1", () => {
  it("should identify the number of valid bag colours for the outermost bag for test data", () => {
    expect(bagRules(testData)).toBe(4);
  });
  it("should identify the number of valid bags for the actual data", () => {
    expect(bagRules(data)).toBe(246);
  });
});
