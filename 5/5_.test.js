...
const testData2 = `FBFBBFFRLR
BFFFBBFRRR
FFFBBBFRRR
BBFFBBFRLL`;

describe("Day 5 - p1", () => {
  test("should identify seatID for single code", () => {
    expect(boarding(testData)).toBe(357);
  });
  test("should identify highest seatId for multiple codes", () => {
    expect(boarding(testData2)).toBe(820);
  });
